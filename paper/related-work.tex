...
the use of Tor Browser and studying how users interact with onion services in particular---the focus of our paper. 
Furthermore, we believe that some of our findings generalize to other
systems.  For example, Freenet~\cite{Freenet} and Bitcoin~\cite{Nakamoto2008a} employ self-authenticating names, too: Freenet uses them in its file naming scheme, and Bitcoin uses them in its addressing scheme.
