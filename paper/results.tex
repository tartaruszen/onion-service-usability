...
of onion domains in the root DNS data described in \Cref{sec:root-data} indicates that
...
\Cref{fig:onion-domain-mgmt}.  Two interview participants did the same.  While
...
protections, some of which were clearly misguided, \mc{whats an example? and why
was it misguided} further highlighting the importance of being able to verify a
...
% ---Philipp: What are ``trusted resources''?---
...
% ---Philipp: What does it mean to ``lower security settings to check the
%  website?---
...
Our interviewees employed many strategies which to verify the authenticity of
...
P26 did not find vanity domains practical and seemed to distrust them: ``I don't
...
now.''  Interestingly, some \adz{how many} survey respondents consider vanity
domains economically unfair because wealthy entities can afford to generate
longer prefixes such as Facebook \mc{explain why in related work}.
...
% ---Philipp: The sentence below seems irrelevant.---
% Furthermore, one interviewee expressed their concern about onion vanity
% domains, saying that he ``wouldn't use it for fun'' (P02).
...
the onion domain.  One survey respondent reported that \textquote{I only
memorize the first part of the domain.} \mc{need participant id} while another
...
may end up going to less onion sites as a result.'' \mc{need participant id}
...
% ---Philipp: The paragraph below is confusing and doesn't contribute.---
% Six interviewees reported that one of their issues is correct webpage
...
results, shown in \Cref{fig:onion-operation-concerns}, more than half of our
...
% ---Philipp: The paragraph below doesn't seem to contribute anything.---
% One interviewee, P16, explained encryption technology issues, his wish to
...
% but I'm just waiting for the encryption technology to become better, and I
% don't think we're that far off it, as in we're talking months. (\ldots)
% another thing about onion services, is whether or not those hosts are actually
% encrypted, and that the data that you actually post on those things is also
% encrypted, so if they are actually taken down by third parties for whatever
% reason, that you can say, "Well it doesn't matter the site's gone, but my
% stuff's pretty much safe, because I have my own key.''

% ---Philipp: The paragraph below doesn't belong to this section.---
...
% participant P01 had a problem with a Firefox  browser regarding onion
% links---it did not recognize .onion domains as being secure. 

\subsubsection{User Experience Design}

Many survey respondents had performance concerns about onion services. \mc{need
participant id}  One survey user stated, ``I would always prefer the onion site
...
we discussed in \Cref{sec:perception}.  Our interviewees mentioned various
...
% ---Philipp: No idea what the paragraph below means.---
...
% to websites would be a feature they would like to see. 
...
17\% who expressed concern over the next generation domain format \mc{can we
define what this is?}, they felt that they would no longer be able to memorize
...
security issues.  One respondent said, \mc{participant id needed}
\textquote{What's to stop them from man-in-the-middle'ing me, either by choice,
at the behest of some nefarious entity, or after being hacked?}  We conclude
...
% ---Philipp: The following is similar but redundant.---
% P07 pointed out, OS are not as popular as they could be: ``I think usability
% is one part. I think. I'm not so much concerned, actually, about the onion
% services being improved, 'cause I think you guys do a very good job. My
% concern is more about getting this out to people who aren't in this space,
% communicating what that is, making sure that there's more uptake of it.'' 

We also asked our survey respondents if they would prefer an onion version of
...
% ---Philipp: Vague, not clear what this is teaching us.---
...
% ---Philipp: Doesn't seem to teach us anything.---
% One of our interviewee thought that bulletin would be a good idea, while 2
% thought that there should be some websites that would help and inform people
% about usage of OS---also, according to one interview participant, the fact that
% there was no support center was a big problem related to OS.

Three of our interviewees referred to the lack of proper education as ``cultural
