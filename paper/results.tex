...
By clicking on the onion icon in the top left corner of Tor Browser, one can see
the circuit that is used for the current web site.  Some of our interviewees
appreciated this visual feedback: \textquote[P08]{I love how I can monitor the
network through this little kind of bar that comes up.}
...
onion services.  Everybody drew a sketch of Tor but not all drew onion services
because they had not experienced them.  Interestingly, all participants
understood that key to Tor's anonymity is the bouncing of network traffic across
several relays, as evidenced by \Cref{fig:tor-sketch}, drawn by a participant
with no technical background.  Analogously, most of our participants understood
that network traffic does not leave the Tor network when connecting to onion
...
\subsubsection{Makeshift tools ease onion service discovery}
...
certificate (36\%).  Alarmingly, almost 30\% of
