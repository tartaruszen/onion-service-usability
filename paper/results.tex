...
tools should notice that other people can make same private key.} Furthermoe,
...
One of the things that remain confusing is the terminology of OS; one interview
...
\Cref{fig:onion-usage}). Moreover,  anonymity was also the main reason why
...
\Cref{fig:onion-discovery} illustrates the results of our survey.  The three
...
While significantly less popular method among our survey participants for
discovering onion domains was through friends and family, which had the
advantage that domains come from a trusted source. \adz{how many?} Finally, 19\%
