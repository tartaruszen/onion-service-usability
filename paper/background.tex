...
resolved and routed inside the Tor network, resulting in a circuit between the
client and the onion service which (by default) features six hops (see
\Cref{fig:onion-connection}).
