...
network traffic traverses six Tor relays (see Figure~\ref{fig:onion-connection})
...
Several organizations including Facebook (\url{facebookcorewwwi.onion}),
ProPublica (\url{propub3r6espa33w.onion}), and the New York Times
(\url{nytimes3xbfgragh.onion}) employ vanity domains.
