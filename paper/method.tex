...
interview.\footnote{The question set is available online but we redacted the
\textsc{url} for anonymization.} The semi-structured nature of our interviews
allowed us to deviate from this question set, \eg, by asking follow-up
questions.  We began by asking demographic information (gender, age range,
occupation, country of residence, and level of education), followed by
information about online behavior, and finally questions specific to Tor Browser
and onion services.

\subsubsection{Procedure}

Our institution's review board (\textsc{irb}) deemed our study exempt from
further review.\footnote{We redacted our \textsc{irb} protocol number for
anonymization.}  We conducted thirteen interviews in person and four interviews
...
in a blog post and on its Twitter account.  Our selection
...
three Reddit subforums.\footnote{We redacted the \textsc{url}s for
anonymization.} Unlike our interview participants, our survey respondents are
