...
ethics.  \annie{Lastly, we discuss how we obtained and used data on {\tt .onion} domains 
leaked via DNS.}
...
Interview transcripts were coded by at least three members of our team and we held regular research meetings to reach consensus on the final themes.  This process
...
\annie{\subsection{DNS Root Data}
...
\annie{We obtained about 72 hours worth of DNS data from the B root server~\cite{b_root}.  This 
